...
public class SubscriptionController {
    ...
    public ApiResponse<SubscriptionResponse> createSubscription(
        ...
        log.info("Creating subscription for partner: {}", request.getPartnerId());
    ...
    public ApiResponse<SubscriptionResponse> getSubscriptionDetail(
    ...
    @GetMapping
    public ApiResponse<PageResponse<SubscriptionResponse>> listSubscriptions(
